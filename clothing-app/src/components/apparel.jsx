    ...
    return ( 
        <div className="flex">
            <div className="flex flex-col items-center relative">
                ...
                <div className="flex flex-col absolute bottom-1/4 right-1/4 -mb-24 -mr-36 gap-3">
            ...
            <div className="flex flex-col relative -mt-32 -ml-96 gap-3">
            <span className="text-2xl font-bold ">Shop Women's Apparel</span>
            <button className="bg-black text-white px-4 py-2 rounded-md">Shop Now</button>
            </div>
            </div>
        </div>
