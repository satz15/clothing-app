...
const Navbar = () => {
    return ( 
        ...
        <div className="flex flex-row gap-5">
          <span className="cursor-pointer text-xl font-sans">Men</span>
          <span className="cursor-pointer text-xl font-sans">Women</span>
          <span className="cursor-pointer text-xl font-sans">About Us</span>
          <div className='flex h-[1.5rem] relative items-center'>
            <input className="rounded-2xl outline-none" type='text' placeholder='search for you'/>
