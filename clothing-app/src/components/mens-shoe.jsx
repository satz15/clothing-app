...
const Shoes = ({addToCart}) => {
  const ItemShop = (props) => {
    return (
      ...
      gap-4 shadow-lg rounded-lg overflow-hidden justify-evenly hover:scale-105 menshoe">
        <img className="mt-full w-74 h-64 object-center shoeone" src={props.image} />
